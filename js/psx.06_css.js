/*global $, pcss, psx*/
// == BEGIN MODULE psx._06_css_ ========================================
psx._06_css_ = (function () {
  ...
  var
    ...
    configMap = {
      _base_list_ : [
        ...
        { _selector_str_ : __p( '.{_p_}-_shell_box_' ),
          _rule_map_     : {
            _display_     : '_block_',
            _position_    : '_absolute_',
            _top_         : '_0_',
        ...
        { _selector_str_ : __p( '.{_p_}-_shell_action_' ),
          _rule_map_     : {
            _display_     : '_block_',
            _position_    : '_absolute_',
            _top_         : '_0_',
        ...
        { _selector_str_ : __p( '.{_p_}-_shell_action_ select' ),
          _rule_map_     : {
            _display_   : '_block_',
            _float_     : '_left_',
        ...
        { _selector_str_ : __p(
            '.{_p_}-_shell_palette_,.{_p_}-_shell_layout_'
          ),
          _rule_map_     : {
            _display_     : '_block_',
            _position_    : '_absolute_',
        ...
        { _selector_str_ : __p( '.{_p_}-_shell_palette_' ),
          _rule_map_     : {
            _left_  : '_0_',
            _right_ : [ '62.5%' ]
          }
        },
        { _selector_str_ : __p( '.{_p_}-_shell_layout_' ),
          _rule_map_     : {
            _left_        : [ '37.5%' ],
            _right_       : '_0_'
          }
        },
        { _selector_str_ : __p( '.{_p_}-_shell_palette_image_' ),
          _rule_map_     : {
            _display_     : '_block_',
            ...
            _background_color_    : '_area_hex_',
            _background_position_ : '_center_',
            _background_repeat_   : '_no_repeat_',
            _background_size_     : '_cover_',
            _cursor_ : '_move_'
          }
        },
        { _selector_str_ : __p( '.{_p_}-_shell_layout_cell_' ),
          _rule_map_     : {
            _display_             : '_block_',
            _position_            : '_relative_',
            _height_              : [ '20rem' ],
            ...
            _border_radius_       : '_d25rem_',
            _box_shadow_          : '_shdw_01_',
            _background_color_    : '_area_mid_hex_',
            _background_position_ : '_center_',
            _background_repeat_   : '_no_repeat_',
            _background_size_     : '_cover_',
            _overflow_            : '_hidden_'
